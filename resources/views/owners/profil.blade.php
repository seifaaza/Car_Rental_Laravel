...
<div class="w-75 container mx-auto py-5 ">
    ...
    <ul class="list-group list-group-flush">
        <li class="list-group-item"><h5> Overview :</h5> {{$car->owners->description}}</li>
        <li class="list-group-item"><h5> Email :</h5> {{$car->owners->email}}</li>
        <li class="list-group-item"><h5> Contact :</h5> 0763849764</li>
      </ul>
</form>
<h2 class="text-danger mt-5">{{$car->owners->name}}'s cars</h2>
